...
pdf(file = "analysis/fig/Fig-Calib1.pdf", width = 10, height = 6)
...
pdf(file = "analysis/fig/Fig-Calib2.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib3.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib4a.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib4b.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
# related outcomes
pdf(file = "analysis/fig/Fig-Calib5.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib6.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib7.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib8.pdf", width = 10, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
...
pdf(file = "analysis/fig/Fig-Calib9.pdf", width = 9, height = 6)
par(mar = c(3,3,1,1), mgp = c(2,1,0))
