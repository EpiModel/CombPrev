...
param <- param_msm(netstats = netstats,
                   epistats = epistats,
                   hiv.test.rate = c(0.00450, 0.00415, 0.00610),
                   hiv.test.late.prob = c(0, 0, 0),
                   tx.init.prob = c(0.178, 0.190, 0.253),
                   tt.part.supp = c(0.45, 0.40, 0.28),
                   tt.full.supp = c(0.55, 0.60, 0.72),
                   tt.dur.supp = c(0, 0, 0),
                   tx.halt.part.prob = c(0.0075*THPP, 0.0070*THPP, 0.0064*THPP),
                   tx.halt.full.rr = c(0.45, 0.45, 0.45),
                   tx.halt.dur.rr = c(0.45, 0.45, 0.45),
                   tx.reinit.part.prob = c(0.0120, 0.0160, 0.0295),
